\documentclass[journal=ACSES&TWater,manuscript=article]{achemso}
...
\hypersetup{breaklinks, colorlinks=true, citecolor=citecolor, linkcolor=linkcolor, urlcolor=urlcolor}
...
\newcommand\orcid[1]{\,\href{https://orcid.org/#1}{\raisebox{2pt}[0pt][0pt]{\scalerel*{
